...
const {addproduct, quantityUpdate, total, buydata, product_pricefilter, min_max_price, discountwithproduct, favoriteColor, searchapi, profile, likesquintaty, rating} = require("../Controller/ProductApi/Addtocard");
...
router.get("/total",verificationMiddleware,total)
